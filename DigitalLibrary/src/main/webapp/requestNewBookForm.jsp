...
<body>
  ...
  <!-- Profile Container -->
    ...
    <div class="container page">
        <div>
          <h1 class="heading">REQUEST NEW BOOK</h1>
          <form action ="requestNewBook" method = "post" enctype="multipart/form-data">
            
            <label class="label">Title</label>
            <div class="input-container">
             <input type="text" id="title" name="title" placeholder = "Enter the book title" class="auth-input" required><br>
            </div>
            ...
            <div class="input-container">
               <textarea name="description" id="description" cols="100" rows="8" placeholder="Why do you think this book should be added to the collection?" class="auth-input"></textarea>
             </div>
             <label class="label">Attachments:</label>
            <div class="input-container">
              <input type="file" name="pdf" class="auth-input"  placeholder = "Book Cover Picture if available!">
              </div>
            <div class="center">
